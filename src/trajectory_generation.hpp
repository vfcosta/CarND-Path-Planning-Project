...
public:
  ...
  void jmtTrajectory(double s, double goal_s, double car_speed, double goal_speed, double accel, double d, double goal_d, double accel_d, double goal_speed_d, double time, vector<double> &next_x_vals, vector<double> &next_y_vals);
...
private:
  ...
  vector<vector<double>> selectBest(double s, double goal_s, double car_speed, double goal_speed, double accel, double d, double goal_d, double accel_d, double goal_speed_d, double &time);
};
