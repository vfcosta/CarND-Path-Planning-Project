...
public:
  ...
  vector<vector<double>> generate(double car_x, double car_y, double car_s, double car_d, double car_yaw, double car_speed, double goal_d, vector<double> previous_path_x, vector<double> previous_path_y);
